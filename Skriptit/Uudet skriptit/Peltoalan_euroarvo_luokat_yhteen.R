...
Cropland_korotettu_elop_hinta<-Cropland_korotettu_elop_hinta %>% select(1:5, 58:length(Cropland_korotettu_elop_hinta))
...
Cropland_korotettu_mineraalimaa_hinta<-Cropland_korotettu_mineraalimaa_hinta %>% select(1:5, 58:length(Cropland_korotettu_mineraalimaa_hinta))
...
Yhdistetyt_pellon_euroarvot<-Yhdistetyt_pellon_euroarvot %>% select(1:5,58:length(Yhdistetyt_pellon_euroarvot))
