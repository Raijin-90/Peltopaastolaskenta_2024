...
Cropland_korotettu_mineraalimaa_sato<-Cropland_korotettu_mineraalimaa_sato %>% select(1:5, 58:length(Cropland_korotettu_mineraalimaa_sato))
...
Cropland_korotettu_elop_sato<-Cropland_korotettu_elop_sato %>% select(1:5, 58:length(Cropland_korotettu_elop_sato))
